...
var setup = function setup(props) {
    ...
    var componentWithoutPlaceholder = (0, _enzyme.mount)(_react2.default.createElement(_ReactSelectSuggest.ReactSelectSuggest, _extends({
        showAttr: 'title',
    ...
    var componentStyle = (0, _enzyme.mount)(_react2.default.createElement(_ReactSelectSuggest.ReactSelectSuggest, _extends({
        placeholder: 'hello',
        showAttr: 'title',
        url: 'https://jsonplaceholder.typicode.com/posts',
        boxHeight: '200',
...
(0, _tape2.default)('changing the input value is calling the ajax function correctly', function (assert) {
    ...
    assert.equal(searchSpy.calledWith('reducer1', 'a', {
        url: 'https://jsonplaceholder.typicode.com/posts',
        showAttr: 'title'
