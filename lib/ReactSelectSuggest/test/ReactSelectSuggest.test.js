...
(0, _tape2.default)('dropdown should be hidden when no results found or the focus is lost', function (assert) {
    ...
    assert.equal(dropDown.props().style.opacity, 0, 'Dropdow is not visible when there are no results');
    ...
    assert.equal(dropDown.props().style.opacity, 0, 'Dropdow should be hidden after losing the focus from input');
