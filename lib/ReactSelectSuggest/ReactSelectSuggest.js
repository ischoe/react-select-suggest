...
var ReactSelectSuggest = exports.ReactSelectSuggest = function (_Component) {
    ...
    _createClass(ReactSelectSuggest, [{
        ...
        value: function componentDidMount() {
            var inputOffset = this.inputField.offsetWidth,
                mainOffset = this.mainBox.offsetWidth;
        ...
        value: function componentDidUpdate(prevProps, prevState) {
            ...
            if (showDropDown && this.dropDown.offsetWidth > 0) {
                var offset = this.inputField.offsetWidth - this.dropDown.offsetWidth;
                if (offset > 0) {
            ...
            if (focusIndex !== false && this.mouseMoveCounter === 0) {
                ...
                if (prevFocusIndex !== focusIndex) {
                    var focusElementTop = this.dropDown.getElementsByClassName('react-select-suggest-focus')[0];
        ...
        value: function handleClickArrow() {
            var _getFromStateOrReduxP3 = this.getFromStateOrReduxProps(),
        ...
        key: 'checkTransition',
        value: function checkTransition(valueToCheck, height) {
            var opacityTime = valueToCheck ? '500ms' : '0ms',
        ...
        key: 'renderDropDown',
        value: function renderDropDown(showTheDropDown, boxHeight, searchResults, showAttr, focusIndex) {
            var _this2 = this;
            ...
            return _react2.default.createElement(
                ...
                showTheDropDown && _react2.default.createElement(
                    'ul',
                    null,
        ...
        key: 'renderErrors',
        value: function renderErrors(error, errorsAvailable) {
            return _react2.default.createElement(
                'div',
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                'div',
                { ref: function ref(node) {
                        return _this3.mainBox = node;
                    }, className: 'react-select-suggest',
