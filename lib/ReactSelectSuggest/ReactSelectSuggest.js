    ...
    _createClass(ReactSelectSuggest, [{
        ...
        value: function componentDidMount() {
            ...
            if (boxWidth) {
                ...
                var _inputOffsetInPx = mainOffset + 'px';

                inputField.style.width = _inputOffsetInPx;
                dropDown.style.width = _inputOffsetInPx;

                var _offset = inputField.offsetWidth - parseInt(inputField.style.width);
                if (_offset > 0) {
                    inputField.style.width = parseInt(inputField.style.width) - _offset + 'px';
                    dropDown.style.width = mainOffset - _offset / 2 + 'px';
                }
            }
        }
    }, {
