...
exports.searchForResults = exports.searchResultsError = exports.clearSearchResults = exports.searchResultsSuccess = exports.searchResultsStart = exports.setFocusIndex = exports.resetSelected = exports.selectItem = exports.changeInputValue = exports.hideDropDown = exports.showDropDown = exports.hidePlaceholder = exports.showPlaceholder = undefined;
...
var resetSelected = exports.resetSelected = function resetSelected(namespace, _resetSelected) {
    return { type: namespace + 'RESET_SELECTED', resetSelected: _resetSelected };
};
var setFocusIndex = exports.setFocusIndex = function setFocusIndex(namespace, index) {
    return { type: namespace + 'SET_FOCUS_INDEX', index: index };
};
...
var _temp = function () {
    ...
    __REACT_HOT_LOADER__.register(resetSelected, 'resetSelected', 'src/ReactSelectSuggest/ReactSelectSuggestActions.js');

    __REACT_HOT_LOADER__.register(setFocusIndex, 'setFocusIndex', 'src/ReactSelectSuggest/ReactSelectSuggestActions.js');
