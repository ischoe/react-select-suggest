...
var _temp = function () {
    ...
    __REACT_HOT_LOADER__.register(setup, 'setup', 'src/components/ReactSelectSuggest/test/ReactSelectSuggest.test.js');

    __REACT_HOT_LOADER__.register(teardown, 'teardown', 'src/components/ReactSelectSuggest/test/ReactSelectSuggest.test.js');
}();
