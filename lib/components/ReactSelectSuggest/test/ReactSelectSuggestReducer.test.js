...
(0, _tape2.default)('SHOW_PLACEHOLDER can be set', function (assert) {
  ...
  assert.deepEqual((0, _ReactSelectSuggestReducer2.default)(state, action), { showPlaceholder: true }, 'SHOW_PLACEHOLDER sets showplaceholder to true');
...
(0, _tape2.default)('HIDE_PLACEHOLDER can be set', function (assert) {
  ...
  assert.deepEqual((0, _ReactSelectSuggestReducer2.default)(state, action), { showPlaceholder: false }, 'HIDE_PLACEHOLDER sets showplaceholder to false');
...
(0, _tape2.default)('INPUT_CHANGE works', function (assert) {
  ...
  assert.deepEqual((0, _ReactSelectSuggestReducer2.default)(state, action), { inputValue: 'ok' }, 'INPUT_CHANGE can change the inputValue');
...
(0, _tape2.default)('SEARCH_RESULTS_START can search for results', function (assert) {
  ...
  assert.deepEqual((0, _ReactSelectSuggestReducer2.default)(state, action), { fetching: true }, 'SEARCH_RESULTS_START starts fetching');
...
(0, _tape2.default)('SEARCH_RESULTS_FINISHED returns the results', function (assert) {
  ...
  assert.deepEqual((0, _ReactSelectSuggestReducer2.default)(state, action), {
    fetching: false,
    searchResults: ['123', '456']
...
(0, _tape2.default)('HIDE_DROPDOWN hides the dropdown', function (assert) {
  ...
  assert.deepEqual((0, _ReactSelectSuggestReducer2.default)(state, action), { showDropDown: false }, 'HIDE_DROPDOWN hides the drop down');
...
(0, _tape2.default)('SHOW_DROPDOWN shows the dropdown', function (assert) {
  ...
  assert.deepEqual((0, _ReactSelectSuggestReducer2.default)(state, action), { showDropDown: true }, 'SHOW_DROPDOWN shows the drop down');
...
(0, _tape2.default)('CLEAR_SEARCH_RESULTS removes the searchresults', function (assert) {
  ...
  assert.deepEqual((0, _ReactSelectSuggestReducer2.default)(state, action), { searchResults: [] }, 'CLEAR_SEARCH_RESULTS clears searchresults');
