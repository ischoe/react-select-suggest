...
var fetchResults = function fetchResults(inputValue, sendData) {
    return function (dispatch) {
        return _axios2.default.get(sendData.url).then(function (result) {
            ...
            return dispatch(searchResultsError(error));
        });
    };
};
;
...
var _temp = function () {
    ...
    __REACT_HOT_LOADER__.register(showPlaceholder, 'showPlaceholder', 'src/components/ReactSelectSuggest/ReactSelectSuggestActions.js');

    __REACT_HOT_LOADER__.register(hidePlaceholder, 'hidePlaceholder', 'src/components/ReactSelectSuggest/ReactSelectSuggestActions.js');

    __REACT_HOT_LOADER__.register(showDropDown, 'showDropDown', 'src/components/ReactSelectSuggest/ReactSelectSuggestActions.js');

    __REACT_HOT_LOADER__.register(hideDropDown, 'hideDropDown', 'src/components/ReactSelectSuggest/ReactSelectSuggestActions.js');

    __REACT_HOT_LOADER__.register(changeInputValue, 'changeInputValue', 'src/components/ReactSelectSuggest/ReactSelectSuggestActions.js');

    __REACT_HOT_LOADER__.register(selectItem, 'selectItem', 'src/components/ReactSelectSuggest/ReactSelectSuggestActions.js');

    __REACT_HOT_LOADER__.register(searchResultsStart, 'searchResultsStart', 'src/components/ReactSelectSuggest/ReactSelectSuggestActions.js');

    __REACT_HOT_LOADER__.register(searchResultsSuccess, 'searchResultsSuccess', 'src/components/ReactSelectSuggest/ReactSelectSuggestActions.js');

    __REACT_HOT_LOADER__.register(clearSearchResults, 'clearSearchResults', 'src/components/ReactSelectSuggest/ReactSelectSuggestActions.js');

    __REACT_HOT_LOADER__.register(searchResultsError, 'searchResultsError', 'src/components/ReactSelectSuggest/ReactSelectSuggestActions.js');

    __REACT_HOT_LOADER__.register(searchForResults, 'searchForResults', 'src/components/ReactSelectSuggest/ReactSelectSuggestActions.js');

    __REACT_HOT_LOADER__.register(fetchResults, 'fetchResults', 'src/components/ReactSelectSuggest/ReactSelectSuggestActions.js');
}();
